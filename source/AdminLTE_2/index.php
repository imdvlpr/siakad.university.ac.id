...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url()?>source/AdminLTE_2/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SIAKAD</b> 1.0</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="<?php echo base_url()?>source/AdminLTE_2/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo base_url()?>source/AdminLTE_2/#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">
                      <div class="pull-left">
                  ...
                  <li>
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">
                      <div class="pull-left">
                        <img src="<?php echo base_url()?>source/AdminLTE_2/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">
                      <div class="pull-left">
                        <img src="<?php echo base_url()?>source/AdminLTE_2/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
              ...
              <li class="footer"><a href="<?php echo base_url()?>source/AdminLTE_2/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url()?>source/AdminLTE_2/#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="<?php echo base_url()?>source/AdminLTE_2/#">View all tasks</a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">1301154417</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">VRE</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url()?>source/AdminLTE_2/#">FIF</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()?>source/AdminLTE_2/#" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url()?>source/AdminLTE_2/#" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="<?php echo base_url()?>source/AdminLTE_2/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="<?php echo base_url()?>source/AdminLTE_2/#"><i class="fa fa-circle text-success"></i> Online</a>
        </div>  
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Jadwal Mata Kuliah</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Fakultas</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Program Studi</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Nilai Mahasiswa</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Kartu Rencana Studi</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Kartu Hasil Studi</a></li>
          </ul>
        </li>             
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url()?>source/AdminLTE_2/#"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="<?php echo base_url()?>source/AdminLTE_2/#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="<?php echo base_url()?>source/AdminLTE_2/#sales-chart" data-toggle="tab">Donut</a></li>
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url()?>source/AdminLTE_2/dist/img/user4-128x128.jpg" alt="user image" class="online">

                <p class="message">
                  <a href="<?php echo base_url()?>source/AdminLTE_2/#" class="name">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url()?>source/AdminLTE_2/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url()?>source/AdminLTE_2/dist/img/user2-160x160.jpg" alt="user image" class="offline">
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <ul class="pagination pagination-sm inline">
                  <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">&laquo;</a></li>
                  <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">1</a></li>
                  <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">2</a></li>
                  <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">3</a></li>
                  <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.box-header -->
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">Add new event</a></li>
                    <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo base_url()?>source/AdminLTE_2/#">View calendar</a></li>
                  </ul>
                </div>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="<?php echo base_url()?>source/AdminLTE_2/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="<?php echo base_url()?>source/AdminLTE_2/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="<?php echo base_url()?>source/AdminLTE_2/javascript:void(0)">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="<?php echo base_url()?>source/AdminLTE_2/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
